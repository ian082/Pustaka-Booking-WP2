...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="" class="btn text-white" data-toggle="modal" data-target="#bukuBaruModal"><i class="fas fa-filealt"></i> Buku Baru</a>
            <table class="mt-3 table table-bordered card1">
                <thead>
                    <tr>
                        <th scope="col">No</th>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('buku'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn text-white" data-dismiss="modal"><i class="fas fa-ban"></i> Close</button>
                    <button type="submit" class="btn text-white"><i class="fas fa-plus-circle"></i> Tambah</button>
                </div>
            </form>
        </div>
    </div>
