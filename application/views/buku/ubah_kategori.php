        ...
        <div class="col-lg-6">
            ...
            <?php foreach ($kategori as $k) { ?>
                <form action="<?= base_url('buku/ubahKategori'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <input type="button" class="form-control form-control-user btn text-white col-lg-3 mt-3" value="Kembali" onclick="window.history.go(-1)">
                        <input type="submit" class="form-control form-control-user btn text-white col-lg-3 mt-3" value="Update">
                    </div>
                </form>
            <?php } ?>
        </div>
